...
CREATE TABLE `subcategoria_av2` (
  `idSubcategoria_Av2` int(11) NOT NULL,
  `Subcategoria2` varchar(45) DEFAULT NULL,
  `idSubcategoria_Av1` int(11) NOT NULL,
  PRIMARY KEY (`idSubcategoria_Av2`,`idSubcategoria_Av1`),
  KEY `fk_Subcategoria_Av1_Subcategoria_Av1_idx` (`idSubcategoria_Av1`),
  CONSTRAINT `fk_Subcategoria_Av1_Subcategoria_Av1` FOREIGN KEY (`idSubcategoria_Av1`) REFERENCES `test`.`subcategoria_av1` (`idSubcategoria_Av1`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-07-19 15:53:29
